...
$.extend($.validator, {
	...
	methods: {
		...
		equalTo: function(value, element, param) {
			...
			// TOD0 find a way to bind the event just once, avoiding the unbind-rebind overhead
...
;(function($) {
	...
	// TOD0 verify if jQuery 1.4's implementation is compatible with older jQuery special-event APIs
